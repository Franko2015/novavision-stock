...
<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" readonly id="NameProduct" value="<?php echo $material['nombreMaterial']; ?>" name="txtNombreMaterial">
...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="StrockProduct" name="txtCantidadMaterial" placeholder="Máximo <?php echo $material['unidades']; ?>">
...
?>
<option name="<?php echo $oficina['id']; ?>" value="<?php echo $oficina['direccionOficina']; ?>"><?php echo $oficina['nombres']; ?> <?php echo $oficina['apellidos']; ?> | <?php echo $oficina['direccionOficina']; ?></option>
</select>
<span class="mdl-textfield__error">Nombre inválido</span>
</div>
</div>
...
<p class="text-center">
<a href="enviarMaterial.php?idSession=<?php echo $mostrarUser['id'] ?>&idMaterial=<?php echo $material['id'];?>&unidades=<?php echo $material['unidades']?>&idOficina=<?php echo $oficina['id']?>">
