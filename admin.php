                    ...
                    <div class="mdl-cell mdl-cell--12-col">
                        <div class="full-width panel mdl-shadow--2dp">
                            ...
                            <div class="full-width panel-content">
                                <form method="get" action="registrarAdministrador.php?idSession="<?php echo $mostrarUser['id'];?>">
                                    <div class="mdl-grid">
                                        <div class="mdl-cell mdl-cell--12-col">
                                ...
                                <div class="mdl-list">
                                  ...
                                  include("conexion.php");
                                    ...
                                    <div class="mdl-list__item mdl-list__item--two-line">
                                        ...
                                        <a class="mdl-list__item-secondary-action" href="editarAdmin.php?id=<?php echo $mostrar['id']; ?>&idSession=<?php echo $idSession ?>"><i class="zmdi zmdi-more"></i></a>
                                    </div>
                                  <?php } ?>
                                </div>
                            </div>
